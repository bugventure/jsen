...
function jsen(schema) {
    ...
    function compile(schema) {
        ...
        function validate(path, schema, doNotReturn) {
            function error(keyword) {
                source('errors.push({ path: "' + path + '", keyword: "' + keyword + '" })');
