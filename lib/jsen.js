...
keywords.type = function (schema) {
    var specified = type.isArray(schema.type) ? schema.type : [schema.type],
...
function createValidator(schema) {
    ...
    function compile(schema) {
        ...
        for (i = 0; i < keys.length; i++) {
            ...
            if (generator) {
                src = generator(schema, cacheCompile, declare);
            }
