...
To get started with JSON Schema, check out the [JSEN schema guide]({{ site.repo_url }}/blob/master/schema.md).
...
Read [changelog.md]({{ site.repo_url }}/blob/master/changelog.md)
